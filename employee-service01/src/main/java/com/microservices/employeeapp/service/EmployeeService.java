...
//		AddressResponse addressResponse = new AddressResponse();
		...
		EmployeeResponce employeeres=new EmployeeResponce();
		 employeeres = modelMapper.map(employee, EmployeeResponce.class);
...
//		employeeResponce.setBloodgroup(employee.getBloodgroup());
	...
	employeeres.setAddressResponse(addressResponse);
		return employeeres;
	}
}
